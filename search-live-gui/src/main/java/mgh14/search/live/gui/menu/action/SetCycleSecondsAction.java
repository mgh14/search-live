 ...
 */
public class SetCycleSecondsAction extends AbstractAction {

  private MenuBarController menuBarController;

  public SetCycleSecondsAction(String text, Icon icon,
  ...
  public void actionPerformed(ActionEvent e) {
    menuBarController.handleNewCycleSecondsSetting();
  }
}
